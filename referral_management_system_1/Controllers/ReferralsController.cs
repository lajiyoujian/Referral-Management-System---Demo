...
namespace referral_management_system_1.Controllers
{
    ...
    public class ReferralController : ControllerBase
    {
        ...
        [HttpGet("{Patient}")]
        public IActionResult GetReferralByPatientName(string Name)
        {
            var referrals = _dbContext.Referrals.FirstOrDefault(r => r.Patient == Name);
            if (referrals == null)
                return NotFound();
        ...
        public IActionResult UpdateReferral(int referralId, [FromBody] Referrals updatedReferral)
        {
            ...
            referrals.Patient = updatedReferral.Patient;
            referrals.Provider = updatedReferral.Provider;
            referrals.Specialty = updatedReferral.Specialty;
